        ...
        <h1 className='pb-1'>Select Payment Method</h1>
             <RadioGroup onValueChange={(value)=>handlePaymentMethodChange(value)} className="flex" defaultValue="RAZORPAY">
                ...
                <RadioGroupItem icon={DotFilledIcon} className="h-9 w-9 " value="RAZORPAY" id="r1"/>
                     <Label htmlFor="r1">
                        <div className='bg-white rounded-md px-5   w-32'>
                            <img className='h-8' src="https://sellonboard.com/wp-content/uploads/2021/09/razorpay.png" alt="" />
                        </div>
                     </Label>
                ...
                <RadioGroupItem icon={DotFilledIcon} className="h-9 w-9 " value="STRIPE" id="r2"/>
                     <Label htmlFor="r2">
                        <div className='bg-white rounded-md px-5   w-32'>
                            <img  className="h-8" src="https://hostbillapp.com/appstore/payment_stripe/images/logo.png" alt="" />
                        </div>
                     </Label>
