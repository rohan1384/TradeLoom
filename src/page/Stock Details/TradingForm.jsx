  ...
  return (
    <div className='space-y-10 p-5'>
       ...
       <div className='flex gap-5 items-center'>
        ...
        <div className='flex items-center justify-between'>
            <p>{orderType=="BUY"?"Available Money":"Available Quantity"} </p>
        ...
        <div>
          ...
          <Button variant="link"  className ="w-full mt-5 text-xl" onClick={()=>setOrderType(orderType=="BUY"?"SELL":"BUY")}>{orderType=="BUY"?"Or Sell":"Or Buy"}</Button>
        </div>
